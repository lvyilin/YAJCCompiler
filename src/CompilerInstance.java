...
public class CompilerInstance {
    ...
    private static void initCompiler6() {
        ...
        SymbolString symbolString120 = new SymbolString(new ArrayList<>(Arrays.asList(Terminal.IDENTIFIER, new Terminal("!="), Terminal.IDENTIFIER)));
        ...
        ProductionRule productionRule7 = new ProductionRule(Condition, new ArrayList<>(Arrays.asList(symbolString12, symbolString120, symbolString121, symbolString122, symbolString123, symbolString124)));
